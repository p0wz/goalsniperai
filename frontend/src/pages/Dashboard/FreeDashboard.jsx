...
export default function FreeDashboard({ user }) {
    const TELEGRAM_LINK = "https://t.me/goalsniperai";
        ...
        <div className="max-w-4xl mx-auto px-6 py-12 space-y-8 animate-in fade-in duration-500">
            ...
            <header className="text-center">
                ...
                <p className="text-text-muted">
                    You have access to limited features with your free account.
                </p>
            </header>
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-6">
                        ...
                        <div className="flex-1 text-center md:text-left">
                            ...
                            <p className="text-text-muted mb-4">
                                ...
                                daily predictions, and custom coupon suggestions with PRO.
                            </p>
                            <div className="flex flex-wrap gap-3 justify-center md:justify-start">
                                <div className="flex items-center gap-1 text-sm text-cyan-300">
                                    <MessageCircle size={16} /> Unlimited Chat
                                </div>
                                <div className="flex items-center gap-1 text-sm text-cyan-300">
                                    <Trophy size={16} /> Daily Tips
                                </div>
                                <div className="flex items-center gap-1 text-sm text-cyan-300">
                        ...
                        <Link to="/pricing">
                            <NeuButton className="px-8 py-4 text-lg font-bold bg-gradient-to-r from-cyan-500 to-blue-600 text-white rounded-xl shadow-lg hover:shadow-xl hover:scale-105 transition-all border-0">
                                Upgrade to PRO 🚀
                            </NeuButton>
                        </Link>
                    </div>
            ...
            <div className="relative">
                ...
                <div className="absolute inset-0 bg-base/80 backdrop-blur-sm flex flex-col items-center justify-center rounded-3xl">
                    ...
                    <p className="font-bold text-lg text-text-main">PRO Membership Required</p>
                    <p className="text-sm text-text-muted mb-4">Upgrade your plan to access this feature</p>
                    <Link to="/pricing">
            ...
            <NeuCard className="bg-gradient-to-br from-blue-900/20 to-cyan-900/20 border border-blue-500/20" padding="p-6">
                <div className="flex flex-col md:flex-row items-center gap-6">
                    ...
                    <div className="flex-1 text-center md:text-left">
                        ...
                        <p className="text-text-muted">
                            Join our Telegram channel for daily free tips,
                            betting insights, and special offers!
                        </p>
                    </div>
                    <a
                        href={TELEGRAM_LINK}
            ...
            {/* Features Comparison */}
            <NeuCard padding="p-6">
                <h3 className="text-lg font-bold mb-4 text-center text-text-main">Feature Comparison</h3>
                <div className="overflow-x-auto">
                    <table className="w-full text-sm">
                        <thead>
                            <tr className="border-b border-text-muted/20">
                                <th className="text-left py-3 px-4 text-text-main">Feature</th>
                                <th className="text-center py-3 px-4 text-text-main">Free</th>
                                <th className="text-center py-3 px-4 text-cyan-400">PRO</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr className="border-b border-text-muted/10">
                                <td className="py-3 px-4 text-text-muted">Telegram Channel</td>
                            ...
                            <tr className="border-b border-text-muted/10">
                                <td className="py-3 px-4 text-text-muted">AI Coupon Suggestions</td>
                                <td className="text-center py-3 px-4 text-red-500">✗</td>
                                <td className="text-center py-3 px-4 text-green-500">✓</td>
                            </tr>
                            <tr className="border-b border-text-muted/10">
                                <td className="py-3 px-4 text-text-muted">Detailed Statistics</td>
                                <td className="text-center py-3 px-4 text-red-500">✗</td>
                                <td className="text-center py-3 px-4 text-green-500">✓</td>
                            </tr>
                            <tr>
                                <td className="py-3 px-4 text-text-muted">Priority Support</td>
                                <td className="text-center py-3 px-4 text-red-500">✗</td>
                                <td className="text-center py-3 px-4 text-green-500">✓</td>
                            </tr>
                        </tbody>
